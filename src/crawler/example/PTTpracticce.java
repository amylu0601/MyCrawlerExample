...
public class PTTpracticce {
	...
	public static void main(String[] args) {
		...
		// 遠端資料路徑
		String uri = "https://www.ptt.cc/bbs/Gossiping/M.1481421663.A.582.html";
		...
		Document jsoup
				...
				//.select(".push-userid,.push-content")

				//.select(".push-tag:matchesOwn(推) + .push-userid")
            for(Element elems:jsoup.select("#main-content *")) {
