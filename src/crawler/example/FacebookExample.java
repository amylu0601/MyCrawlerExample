...
public class FacebookExample {
	...
	public static void main(String[] args) {
        ...
        String uri=
				"https://graph.facebook.com/v2.5"
		       +"/search?q=%E4%BB%A3%E8%B3%BC&type=page&limit=10&fields=name,id,likes,talking_about_count"
				+"&access_token=EAACEdEose0cBAO98tMYYzd6AvwUmwTJTksW2cuXsInIa5xdXv1jwhNkrRk9AejxvlNrgc8FONWcCghSZA5ZBRsUlBZA83zsndwZCR7WEpSazUchkSlMMfeOzgJsPvtAPXkLF6aSA54byMzD3bWxCiu26DzgkvfgHZB0uwmXb1cAZDZD";
